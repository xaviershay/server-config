  ...
  RSpec.describe 'DNS Configuration for veganmelbourne.com.au' do
    let(:dns) do
      config = {}
...
describe 'MX records' do
  let(:records) { dns.getresources('veganmelbourne.com.au', Resolv::DNS::Resource::IN::MX) }
...
describe 'TXT records' do
  let(:records) { dns.getresources('veganmelbourne.com.au', Resolv::DNS::Resource::IN::TXT) }
