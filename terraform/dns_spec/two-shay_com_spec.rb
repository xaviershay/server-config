  ...
  RSpec.describe 'DNS Configuration for two-shay.com' do
    let(:dns) do
      config = {}
...
describe 'MX records' do
  let(:records) { dns.getresources('two-shay.com', Resolv::DNS::Resource::IN::MX) }
...
describe 'TXT records' do
  let(:records) { dns.getresources('two-shay.com', Resolv::DNS::Resource::IN::TXT) }
