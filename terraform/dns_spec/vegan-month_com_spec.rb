  ...
  RSpec.describe 'DNS Configuration for vegan-month.com' do
    let(:dns) do
      config = {}
...
describe 'MX records' do
  let(:records) { dns.getresources('vegan-month.com', Resolv::DNS::Resource::IN::MX) }
...
describe 'TXT records' do
  let(:records) { dns.getresources('vegan-month.com', Resolv::DNS::Resource::IN::TXT) }
