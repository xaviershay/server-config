  ...
  RSpec.describe 'DNS Configuration for eventhandapp.com' do
    let(:dns) do
      config = {}
...
describe 'MX records' do
  let(:records) { dns.getresources('eventhandapp.com', Resolv::DNS::Resource::IN::MX) }
...
describe 'TXT records' do
  let(:records) { dns.getresources('eventhandapp.com', Resolv::DNS::Resource::IN::TXT) }
