  ...
  RSpec.describe 'DNS Configuration for dbisyourfriend.com' do
    let(:dns) do
      config = {}
...
describe 'MX records' do
  let(:records) { dns.getresources('dbisyourfriend.com', Resolv::DNS::Resource::IN::MX) }
...
describe 'TXT records' do
  let(:records) { dns.getresources('dbisyourfriend.com', Resolv::DNS::Resource::IN::TXT) }
